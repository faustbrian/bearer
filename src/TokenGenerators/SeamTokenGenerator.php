...
final class SeamTokenGenerator implements TokenGeneratorInterface
{
     ...
     *
     * This alphabet ensures tokens remain readable and reduces transcription
     * errors by eliminating characters that look similar in most fonts.
     */
     ...
     *
     * Uses random_int() for cryptographic randomness and selects characters
     * from the base58 alphabet to build a string of the specified length. Each
     * character is independently selected with uniform distribution.
     *
