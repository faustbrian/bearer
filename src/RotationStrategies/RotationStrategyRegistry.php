...
final class RotationStrategyRegistry
{
     ...
     *
     * @throws CannotSetDefaultRotationStrategyException If the strategy is not registered
     */
    public function setDefault(string $name): void
    {
        if (!$this->has($name)) {
            throw CannotSetDefaultRotationStrategyException::cannotSetAsDefault($name);
        }
