 ...
 *
 * This driver provides a no-op implementation of the AuditDriverInterface
 * contract, useful for testing, development, or production environments where
 * audit logging is not required or would create unnecessary overhead.
 *
 * Use cases: - Testing environments where audit logs are not needed -
 * Performance-critical applications that don't require audit trails -
 * Development setups to reduce database writes - Temporary disabling of audit
 * logging without code changes - Mock implementations in unit tests
 *
 * Example usage: ```php // In config/bearer.php 'audit' => [
 *     'driver' => 'null',
 * ],
 *
