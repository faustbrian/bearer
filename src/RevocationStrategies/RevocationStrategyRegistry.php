...
final class RevocationStrategyRegistry
{
     ...
     *
     * @throws CannotSetDefaultRevocationStrategyException If the strategy is not registered
     */
    public function setDefault(string $name): void
    {
        if (!$this->has($name)) {
            throw CannotSetDefaultRevocationStrategyException::cannotSetAsDefault($name);
        }
