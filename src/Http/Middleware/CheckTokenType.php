...
final class CheckTokenType
{
     ...
     * @throws TokenTypeNotAllowedException If the token type doesn't match any allowed type
     *
    ...
    public function handle(Request $request, Closure $next, string ...$types): mixed
    {
        ...
        if (!in_array($currentType, $types, true)) {
            throw TokenTypeNotAllowedException::notAllowedForRequest($currentType, $types);
        }
