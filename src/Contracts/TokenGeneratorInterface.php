 ...
 *
 * // Generate a new token $plainToken = $generator->generate('usr',
 * 'production'); // Returns: "usr_prod_abc123def456..."
 *
 * // Hash for storage $hashedToken = $generator->hash($plainToken);
 *
 * // Later: verify a token if ($generator->verify($plainToken, $hashedToken)) {
 *     // Token is valid
 * }
 *
