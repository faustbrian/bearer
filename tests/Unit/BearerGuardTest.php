...
describe('BearerGuard', function (): void {
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws TokenHasBeenRevokedException for revoked tokens', function (): void {
            $user = createUser(['email' => uniqid().'@example.com']);
        ...
        test('throws TokenHasExpiredException when token exceeds expiration minutes', function (): void {
            ...
            expect(fn () => $this->withHeader('Authorization', 'Bearer '.$plainToken)->get('/test-auth'))
                ->toThrow(TokenHasExpiredException::class);
        });

        test('throws TokenHasExpiredException when expires_at is in the past', function (): void {
            $user = createUser(['email' => uniqid().'@example.com']);
