...
describe('CheckAbilities', function (): void {
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws SingleAbilityMissingException when token lacks first required ability', function (): void {
            // Arrange
            $user = createUser();
            ...
            expect(fn (): mixed => $middleware->handle(
                ...
                'read:posts',
                'write:posts',
            ))->toThrow(SingleAbilityMissingException::class);
        });

        test('throws SingleAbilityMissingException when token lacks second required ability', function (): void {
            // Arrange
            $user = createUser();
        ...
        test('throws SingleAbilityMissingException when token has no abilities', function (): void {
            // Arrange
            $user = createUser();
...
describe('CheckEnvironment', function (): void {
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws EnvironmentNotAllowedException when environment does not match', function (): void {
            // Arrange
            $user = createUser();
            ...
            expect(fn (): mixed => $middleware->handle(
                ...
                fn ($req): string => 'success',
                'test',
            ))->toThrow(EnvironmentNotAllowedException::class);
        });

        test('throws EnvironmentNotAllowedException when environment not in allowed list', function (): void {
            // Arrange
            $user = createUser();
...
describe('CheckForAnyAbility', function (): void {
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws AnyAbilityMissingException when token has none of the required abilities', function (): void {
            // Arrange
            $user = createUser();
            ...
            expect(fn (): mixed => $middleware->handle(
                ...
                'read:posts',
                'write:posts',
            ))->toThrow(AnyAbilityMissingException::class);
        });

        test('throws AnyAbilityMissingException when token has no abilities', function (): void {
            // Arrange
            $user = createUser();
            $token = createMiddlewareTestToken($user, 'sk', ['abilities' => []]);
...
describe('CheckTokenType', function (): void {
    ...
    describe('Sad Path', function (): void {
        ...
        test('throws TokenTypeNotAllowedException when type does not match', function (): void {
            // Arrange
            $user = createUser();
            $token = createMiddlewareTestToken($user, 'pk', ['environment' => 'test']);
            ...
            expect(fn (): mixed => $middleware->handle(
                ...
                fn ($req): string => 'success',
                'sk',
            ))->toThrow(TokenTypeNotAllowedException::class);
        });

        test('throws TokenTypeNotAllowedException when type not in allowed list', function (): void {
            // Arrange
            $user = createUser();
            $token = createMiddlewareTestToken($user, 'rk', ['environment' => 'test']);
